...
function Feeling() {
  ...
  const submitOrder = () => {
    //function that handles the transfer from client side to index.js(store)
    if (feeling === '') {
    ...
    } //this is the next step/page that the user will see on the dom after dispatch
  };

  const handleSubmit = (event) => {
    //the event handler for when the button is clicked to initiate the transfer of the input
